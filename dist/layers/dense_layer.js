...
class DenseLayer extends layer_1.default {
    ...
    buildLayer(prevLayerShape) {
        ...
        this.weights = new tensor_1.default([prevLayerShape[0], this.layerSize], true);
        this.bias = new tensor_1.default([1, this.layerSize], true);
        this.weights.populateRandom();
        this.bias.populateRandom();
        this.errorWeights = new tensor_1.default();
        this.errorBias = new tensor_1.default();
        this.output_error = new tensor_1.default();
    ...
    feedForward(input, isInTraining) {
        if (this.useGpu) {
            ...
            let act = input instanceof tensor_1.default ? input : input.activation;
    ...
    backPropagation(prev_layer, next_layer) {
        if (this.useGpu) {
            ...
            let dzh_dwh = next_layer instanceof layer_1.default ? next_layer.activation : next_layer;
